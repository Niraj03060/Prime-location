!(function () {
  ...
  function d() {
    if (document.body) {
      ...
      if (
        ...
        u > c &&
        (t.offsetHeight <= c || n.offsetHeight <= c) &&
        ((n.style.height = "auto"), l.offsetHeight <= c)
      ) {
      ...
      var s = e === document.body,
        d = function (n) {
          ...
          s
            ...
            t || r || (f = []),
            f.length ? M(d, e, o / a.frameRate + 1) : (p = !1);
        };
      M(d, e, 0), (p = !0);
    }
  }
  ...
  function T(e) {
    return e >= 1
      ...
      : e <= 0
      ? 0
      : (1 == a.pulseNormalize && (a.pulseNormalize /= C(1)), C(e));
  }
  var z = /chrome/i.test(window.navigator.userAgent);
  "onmousewheel" in document &&
    z &&
    (x("mousedown", function (t) {
      e = t.target;
    }),
